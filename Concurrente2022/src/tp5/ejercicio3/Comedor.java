...
public class Comedor {
	private int cantGatosEsperando, cantPerrosEsperando, cantTotalGatos, cantTotalPerros, limite, cantGatosComiendo,
			cantPerrosComiendo;
				...
				if (cantTotalGatos >= limite) {
					if (cantPerrosEsperando > 0) {
						System.out.println(Thread.currentThread().getName()
								+ "  se llego al limite de gatos y hay perros esperando");
						cantGatosComiendo = 0;
						// hay perros
						...
						if (cantGatosEsperando > 0) {
							System.out.println(
									Thread.currentThread().getName() + "  se llego al limite de gatos NO HABIA PERROS");
							// pero si gatos
							entrarGatos.release();
						} else {
							System.out.println(Thread.currentThread().getName()
									+ "  se llego al limite de gatos NO HABIA PERROS NI GATOS");
							// SETEAR EN 0
					...
					System.out.println(
							Thread.currentThread().getName() + "  NO se llego al limite de gatos Y NO HABIA MAS GATOS");
					if (cantGatosEsperando == 0) {
						if (cantPerrosEsperando > 0) {
							System.out.println(Thread.currentThread().getName()
									+ "  NO se llego al limite de gatos Y NO HABIA MAS GATOS PERO SI PERROS");
							entrarGatos = new Semaphore(0);
							entrarPerros.release(limite);
						} else {
							// si no viene nadie
							System.out.println(Thread.currentThread().getName()
									+ "  NO se llego al limite de gatos Y NO HABIA MAS GATOS NI PERROS");
							entrarGatos = new Semaphore(0);
							entrarPrimerAnimal.release();
						}
		...
		try {
			...
			if (cantPerrosComiendo == 0) {
				...
				if (cantTotalPerros >= limite) {
					if (cantGatosEsperando > 0) {
						System.out.println(Thread.currentThread().getName()
								+ "  se llego al limite de perros y hay gatos esperando");
						cantPerrosComiendo = 0;
						// hay gatos
						...
						if (cantPerrosEsperando > 0) {
							System.out.println(Thread.currentThread().getName()
									+ "  se llego al limite de perros pero NO HABIA GATOS");
							// pero si perros
							...
							// no hay niguno de los 2
							System.out.println(Thread.currentThread().getName()
									+ "  se llego al limite de perros pero NO HABIA GATOS NI PERROS");
							entrarPerros = new Semaphore(0);
							entrarPrimerAnimal.release();
					...
					if (cantPerrosEsperando == 0) {
						if (cantGatosEsperando > 0) {
							System.out.println(Thread.currentThread().getName()
									+ "  NO se llego al limite de perros pero SI HABIA GATOS ");
							entrarPerros = new Semaphore(0);
							entrarGatos.release(limite);
						} else {
							// si no viene nadie
							System.out.println(Thread.currentThread().getName()
									+ "  NO se llego al limite de perros pero tampoco HABIA GATOS ");
							entrarPerros = new Semaphore(0);
							entrarPrimerAnimal.release();
						}
